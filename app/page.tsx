...
export default function Home() {
  ...
  const isVideoWallpaper = wallpaper && (wallpaper.endsWith('.mp4') || wallpaper.endsWith('.webm') || wallpaper.endsWith('.mov'))
  ...
  if (!hasChecked) {
    return (
      <div className="font-sans min-h-screen bg-[#101010]" />
    )
  }
  ...
  return (
    <div
      className="font-sans min-h-screen bg-[#101010] relative"
      style={{
        background: !wallpaper || isVideoWallpaper
          ? `#101010`
          : `url(${wallpaper}) center/cover no-repeat fixed`,
      }}
    >
      ...
      {!isVideoWallpaper && wallpaper === '' && (
        <div
          ...
          style={{
            background: `url(https://raw.githubusercontent.com/y4th4rthh/neura-explore/refs/heads/main/app/macOS-Catalina-Light-mode.jpg) center/cover no-repeat fixed`,
          }}
        />
      )}
      ...
      {/* Main Content */}
      <main className="flex flex-col items-center justify-center min-h-screen px-4 py-12 relative z-10">
        {/* Logo */}
        <div className="mb-8 text-center">
          <h1 className="text-4xl md:text-5xl font-light text-white tracking-tight">
            {greeting}
